...
4. Import data and model wrappers.
Import data and model wrappers into the environment where UniCoMTE will be executed. 
...
“[UniCoMTE/Sandia_Comlex_ECG_Implementation_Full_Training.ipynb](UniCoMTE/Sandia_Comlex_ECG_Implementation_Full_Training.ipynb)” demonstrates the application of a modified version of UniCoMTE that utilizes the full CODE15 training dataset. 

“[UniCoMTE/Full_ECG_Data_Preprocessing_Pipeline.ipynb](UniCoMTE/Full_ECG_Data_Preprocessing_Pipeline.ipynb)” demonstrates the extraction and preprocessing of the CODE testing and training data.
